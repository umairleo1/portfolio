      ...
      <div className="container">
        <div className="footer__content">
          ...
          <div className="footer__links">
            ...
            <a href={personalInfo.twitter} target="_blank" rel="noopener noreferrer" className="footer__link">
          ...
          <div className="footer__bottom">
            <p className="footer__text">
              © {currentYear} {personalInfo.name.toLowerCase()}. built with react, typescript & three.js.
            </p>
            <div className="footer__tech">
              {renderIcon(FaReact, { className: 'tech-icon', title: 'React' })}
              {renderIcon(SiTypescript, { className: 'tech-icon', title: 'TypeScript' })}
              {renderIcon(SiThreedotjs, { className: 'tech-icon', title: 'Three.js' })}
            </div>
          </div>
        </div>
      </div>
