      ...
      <div className="container">
        ...
        <div className="expertise__content">
          {categories.map((category, index) => (
            <div key={index} className="expertise__category" data-aos="fade-up" data-aos-delay={index * 100}>
              <span className="expertise__category-icon">{category.icon}</span>
              <h3 className="expertise__category-title">{category.title}</h3>
              <p className="expertise__category-description">{category.description}</p>
              <div className="expertise__skills">
                {category.skills.map((skill, skillIndex) => (
                  <span key={skillIndex} className="skill-tag" data-aos="fade-in" data-aos-delay={index * 100 + skillIndex * 50}>
                    {skill}
                  </span>
                ))}
              </div>
        ...
        <div className="expertise__stats" data-aos="fade-up" data-aos-delay="200">
